...
export default function HomePage() {
  ...
  function startHearts() {
    ...
    function drawHearts() {
      ...
      // very subtle soft glow to make hearts pop on pink bg
      ...
      grad.addColorStop(0, "rgba(255,240,247,0.02)");
    ...
    <>
        ...
        <div className="container">
          <div className="left">
            <div className="welcome-box" role="region" aria-label="Welcome to Milan">
              ...
              <h3 className="tagline">Where Hearts Connect 💞</h3>
              ...
              <div className="why-grid">
                ...
                <div className="why-card">
                  ...
                  <p>Soft animations and a gentle atmosphere for real connections.</p>
                </div>
                <div className="why-card">
            ...
            <div className="form-container" role="form" aria-label="Signup or Login">
                ...
                <div id="registerForm">
                  ...
                  <div className="terms-container">
                    ...
                    <label htmlFor="terms" style={{ marginLeft: 8 }}>
                      I agree to the <a href="/terms.html">Terms & Conditions</a>, <a href="/privacy.html">Privacy Policy</a> and <a href="/guidelines.html">Community Guidelines</a>
                    </label>
                  </div>
                  <button className="primary-btn" onClick={onRegisterClick} disabled={loadingRegister} aria-busy={loadingRegister} onMouseDown={rippleEffect}>
                    {loadingRegister ? <span className="btn-loader" aria-hidden></span> : null} Register & Start
                  </button>
              ...
              {showLogin && !showReset && (
                <div id="loginForm">
                  ...
                  <button className="primary-btn" onClick={handleLogin} disabled={loadingLogin} onMouseDown={rippleEffect}>
                    {loadingLogin ? <span className="btn-loader" /> : null} Login
                  </button>
              ...
              {showReset && (
                <div id="resetForm">
                  ...
                  <button className="primary-btn" onClick={handleReset} disabled={loadingLogin} onMouseDown={rippleEffect}>
                    {loadingLogin ? <span className="btn-loader" /> : null} Reset Password
                  </button>
        ...
        <div className="modal-back" role="dialog" aria-modal>
          <div className="modal">
            ...
            <div className="modal-actions">
              <button className="ghost-btn" onClick={() => { setShowConsent(false); }} onMouseDown={rippleEffect}>Cancel</button>
      ...
      <style jsx global>{`
        html, body {
          ...
          /* stronger romantic pink-purple background */
          background: radial-gradient(900px circle at 10% 10%, #fff0f6 0%, #ffe8f3 20%, #f8dff3 50%, #f4e9ff 100%);
        }
      ...
      <style>{`
        ...
        /* hearts canvas behind everything */
        #heartsCanvas{ position:fixed; inset:0; z-index:0; pointer-events:none; }

        .page-wrap{ position:relative; z-index:2; min-height:100svh; display:flex; flex-direction:column; justify-content:space-between; padding-bottom:24px; }
        ...
        /* GLASSY, CONTRASTED BOXES */
        .welcome-box{
          position:relative;
          background: linear-gradient(180deg, rgba(255,245,250,0.86), rgba(255,240,247,0.82));
          border-radius:18px;
          padding:34px 36px;
          box-shadow: 0 18px 60px rgba(196,108,196,0.08);
          max-width:820px;
          text-align:center;
          border: 1px solid rgba(255,107,149,0.12);
          backdrop-filter: blur(6px) saturate(1.05);
        }

        .form-container{
          width:100%;
          background: linear-gradient(180deg, rgba(255,244,249,0.86), rgba(255,238,245,0.82));
          padding:24px;
          border-radius:18px;
          backdrop-filter: blur(6px) saturate(1.02);
          box-shadow: 0 18px 60px rgba(196,108,196,0.06);
          border: 1px solid rgba(196,108,196,0.06);
        }

        .welcome-row{ display:flex; align-items:center; gap:12px; justify-content:center; }
        .welcome-title{ font-size:56px; margin:0; font-weight:900; background: linear-gradient(90deg, var(--accent1), var(--accent2)); -webkit-background-clip:text; -webkit-text-fill-color:transparent; text-shadow:0 8px 24px rgba(196,108,196,0.06); }
        .pulse-heart{ display:inline-block; font-size:36px; color:var(--accent1); animation: heartBeat 1100ms ease-in-out infinite; transform-origin:center; text-shadow: 0 8px 22px rgba(255,95,149,0.08); }
        .tagline{ margin:8px 0 2px; font-size:20px; color: #a57fb3; font-weight:800; }
        ...
        .why-card{ background: linear-gradient(180deg, rgba(255,255,255,0.95), rgba(255,249,255,0.97)); border-radius:12px; padding:16px; width:220px; box-shadow: 0 12px 36px rgba(196,108,196,0.04); border:1px solid rgba(196,108,196,0.04); }
        ...
        label{ display:block; margin-top:10px; font-size:14px; font-weight:700; color:#6b5871; }
        input,select,textarea{ width:100%; padding:12px 14px; margin-top:6px; border-radius:10px; border:none; font-size:15px; background: rgba(255,241,246,0.9); color:#3b2b3d; outline:2px solid transparent; transition: outline 120ms ease, transform 100ms ease; }
        input:focus,select:focus,textarea:focus{ outline:2px solid rgba(255,107,149,0.16); transform: translateY(-2px); }
        .primary-btn{ position:relative; overflow:hidden; display:inline-flex; align-items:center; justify-content:center; gap:8px; width:100%; padding:12px 14px; border-radius:12px; border:none; cursor:pointer; font-weight:900; font-size:15px; background: linear-gradient(90deg, #ff6b81, #ff9fb0); color:#071320; box-shadow: 0 12px 36px rgba(196,108,196,0.08); }
        ...
        .support-text{ font-size:14px; color:#6b5871; margin:6px 0; }
